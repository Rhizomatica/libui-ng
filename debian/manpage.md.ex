% libui-ng(SECTION) | User Commands
%
% "January 13 2025"
...
libui-ng - program to do something

# SYNOPSIS

**libui-ng** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**libui-ng** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **libui-ng** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**libui-ng** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    libui-ng. See **foo.conf**(5) for further details.
...
**libui-ng** provides some return codes, that can be used in scripts:
